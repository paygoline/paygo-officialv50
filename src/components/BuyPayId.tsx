...
const BuyPayId = ({
  ...
  const renderServiceNotice = () => <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="border-l-4 border-red-400 p-4 mb-4 bg-red-50">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-red-600">✓</span>
            <h4 className="font-bold text-red-600">Opay Bank Service is Currently down</h4>
          </div>
          <p className="text-sm text-red-600">All bank transfers are now working normally. You can proceed with your payment safely.</p>
        </div>
        
        <p className="text-gray-600 text-sm mb-6">We appreciate your patience. All banks except Opay use any other banks and your payment will be processed immediately.</p>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <span className="text-xl font-bold text-gray-900">VFD MFB</span>
                </div>

                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  <span className="text-gray-700 font-medium">Account Number</span>
                  <div className="flex items-center space-x-3">
                    <span className="text-xl font-bold text-gray-900">1043288865</span>
                    <Button onClick={() => handleCopy('1043288865')} className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 text-sm rounded-md">
                      Copy
                    </Button>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <span className="text-xl font-bold text-gray-900">NANBOL JOSHUA DAVID</span>
                </div>
              </div>
